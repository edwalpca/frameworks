 ...
 */
 ...
 if(!isset($_pagi_nav_anterior)){
	...
	$_pagi_nav_anterior = "&laquo; "."atr&aacute;s";
 } 
 ...
 if(!isset($_pagi_nav_primera)){
	...
	// Se toma la cadena por defecto.
	$_pagi_nav_primera = "&laquo;&laquo; "."Inicio";
 } 
 
 if(!isset($_pagi_nav_ultima)){
	// Si no se ha elegido una cadena para el enlace "siguiente"
	// Se toma la cadena por defecto.
	$_pagi_nav_ultima = "&uacute;ltimo"." &raquo;&raquo;";
 } 
 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
 	$_pagi_sqlConta = $_pagi_sql;//$_pagi_sqlConta = eregi_replace("select[[:space:]](.*)[[:space:]]from", "SELECT COUNT(*) FROM", $_pagi_sql);
	...
	// Si ocurrió error y mostrar errores está activado
 	if($_pagi_result2 == false && $_pagi_mostrar_errores == true){
        ...
        $_pagi_totalReg = mysql_num_rows($_pagi_result2);
 ...
 */
 ...
 if ($_pagi_actual != 1){
	...
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>$_pagi_nav_primera</a></li>";

	// Si no estamos en la página 1. Ponemos el enlace "anterior"
	$_pagi_url = $_pagi_actual - 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>$_pagi_nav_anterior</a></li>";
 }
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
	if ($_pagi_i == $_pagi_actual) {
		...
		$_pagi_navegacion_temporal[] = "<li class=\"active\"><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_i."'>$_pagi_i</a></li>";
	}else{
		// Si es cualquier otro. Se escibe el enlace a dicho número de página.
		$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_i."'>".$_pagi_i."</a></li>";
	}
 }
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>$_pagi_nav_siguiente</a></li>";
	...
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>$_pagi_nav_ultima</a></li>";
 }
